/**
* The RadListView module defines all types needed to setup a ListView control with
* different layouts and customizations.
*/
declare module "listview" {
    ...
    */
    ...
    class ListViewLayoutBase extends bindableModule.Bindable {

    }

    /**
    * A base layout used to render cells in ListView.
    */
    export class ListViewLinearLayout extends ListViewLayoutBase {
        ...
        */
        static animationDurationProperty: dependencyObservable.Property;
        /**
        * The duration of animation.
        */
        animationDuration: number;
        /**
        * Identifies the {@link itemAlignment} dependency property.
        */
        static itemAlignmentProperty: dependencyObservable.Property;
        /**
        * The desired cell alignment within a column.
        */
        itemAlignment: string;
        /**
        * Identifies the {@link itemSpacing} dependency property.
        */
        static itemSpacingProperty: dependencyObservable.Property;
        /**
    ...
    /**
    * A layout that renders cells in ListView by distributing them in a fixed columns count. Supports cell alignment e.g. left, right , center, justify
    */
    ...
    */
    export class RadListView extends viewModule.View {
        ...
        /**
         * This event is fired when the user starts swiping a cell.
        ...
        /**
         * This event is fired when the user starts swiping a cell. The event
        ...
        */
        ...
        /**
        * Identifies the {@link cellReorder} dependency property.
        */
        static cellReorderProperty: dependencyObservable.Property;
        /**
        * Identifies the {@link swipeCells} dependency property.
        */
        static swipeCellsProperty: dependencyObservable.Property;
        /**
